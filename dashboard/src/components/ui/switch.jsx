/*
 * switch — shadcn/ui sobre Radix, retocado a tokens (encendido = accent del tema).
 */
...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        'pointer-events-none block h-4 w-4 rounded-full bg-surface shadow-sm ring-0 transition-transform duration-fast',
